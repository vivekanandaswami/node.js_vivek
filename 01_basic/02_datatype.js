"use strict";// treate js code as modern js code//

alert( 3+1) // we are using alert function to show a message in the browser and we are using javascript //

console( 3
    +1 
) // make code more readablity by proper indentation//
...
// let bigintNumber = 1234567890123456789012345678901234567890n // bigint datatype//
